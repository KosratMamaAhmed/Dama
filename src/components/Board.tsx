...
export default function Board({
  ...
  const themeClasses = {
    ...
    KURDISH_WOOD: {
      outer: 'bg-[linear-gradient(135deg,#54290c_0%,#2c1201_100%)] border-amber-700/60 shadow-amber-950/90 shadow-[inset_0_4px_30px_rgba(0,0,0,0.8)]',
      lightSquare: 'bg-[linear-gradient(to_bottom_right,#92400e_0%,#78350f_100%)] border-amber-900/30 text-amber-100',
